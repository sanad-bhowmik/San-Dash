                                    ...
                                    <div class="mb-3">
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="password-addon" style="height: 41px;border-top-left-radius: 0;border-bottom-left-radius: 0;border-top-right-radius: 0.25rem;border-bottom-right-radius: 0.25rem;border-right: 1px solid gainsboro;">
                                                    <i class="fa fa-eye" id="togglePassword" style="cursor: pointer;"></i>
                                                </span>
                                            </div>
                                        </div>
                                        <!-- Script for Password Show/Hide -->
                                        <script>
